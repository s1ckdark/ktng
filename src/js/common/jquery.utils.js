	...
	*/
	...
	$.fn.loadAd = function (options) {
		...
		AD_INFO = {
			...
			'premium_text': { width: '260', height: '193', src: 'http://adpingpong1.co.kr/joongang_wrt.html', title: '프리미엄링크 광고', id: 'premium_text', name: 'premium_text' },
			...
			'display_0215_1': { width: '1060', height: '70', src: 'http://dgate.joins.com/hc.aspx?ssn=830&b=joins.com', id: 'DASlot830', name: 'DASlot830' }, // 2월 15일 ~ 2월 21일 광고
			...
			'ad_text_recommanded': { width: '260', height: '42', src: 'http://agate.opap.co.kr/html/joongang/joongang36', title: '아티클 우측 추천기사 텍스트', id: 'ad_text_recommanded', name: 'ad_text_recommanded' }
		};
		//return false;
		var $p = this,
